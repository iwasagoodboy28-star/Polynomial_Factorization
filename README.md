...
Overall program with squarefree is in Factoriation_with_Squarefree.sage and is written in sage. For example, you can use it on [SageMathCell](https://sagecell.sagemath.org/) 
